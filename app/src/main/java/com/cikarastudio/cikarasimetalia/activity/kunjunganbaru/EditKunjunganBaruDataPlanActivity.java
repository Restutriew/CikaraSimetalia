...
public class EditKunjunganBaruDataPlanActivity extends AppCompatActivity {
    ...
    private static final String URL_UPDATEPLANBARU = "http://simetalia.com/android/update_plan_baru.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(EditKunjunganBaruDataPlanActivity.this);
        loadingDialog.startLoading();

        Intent intent = getIntent();
        id_kunjunganBaru = intent.getStringExtra(ID_KUNJUNGANBARU);

        sp_editPlanBaruTabletFE = findViewById(R.id.sp_editPlanBaruTabletFE);
        sp_editPlanBaruJumObat = findViewById(R.id.sp_editPlanBaruJumObat);
        sp_editPlanBaruImunisasiTT = findViewById(R.id.sp_editPlanBaruImunisasiTT);
        sp_editPlanBaruYangKe = findViewById(R.id.sp_editPlanBaruYangKe);
        tv_editPlanBaruTerapiLain = findViewById(R.id.tv_editPlanBaruTerapiLain);
        tv_editPlanBaruEdukasi = findViewById(R.id.tv_editPlanBaruEdukasi);
        btn_toggleEditPlanBaru = findViewById(R.id.btn_toggleEditPlanBaru);
        btn_updateDataPlanBaru = findViewById(R.id.btn_updateDataPlanBaru);
    ...
    private void updateDataPlanBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATEPLANBARU,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Update Data Plan Berhasil", Toast.LENGTH_LONG).show();
                                loadingDialog.dissmissDialog();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Update Data Plan Gagal!", Toast.LENGTH_LONG).show();
                            loadingDialog.dissmissDialog();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Update Data Plan Gagal! : Cek Koneksi Anda", Toast.LENGTH_LONG).show();
                        loadingDialog.dissmissDialog();
                    }
                }) {
            @Override
    ...
    private void togglePlanBaru() {
        if (!tv_editPlanBaruTerapiLain.isEnabled()) {
            ...
            Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Mode Edit Diaktifkan!", Toast.LENGTH_LONG).show();
            ...
            sp_editPlanBaruImunisasiTT.setEnabled(false);
            sp_editPlanBaruYangKe.setEnabled(false);
            Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Mode Edit Dinonaktifkan!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadDataPlanBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_READBOOKING,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                ArrayAdapter<String> tabletFeAdapter = new ArrayAdapter<String>(EditKunjunganBaruDataPlanActivity.this,
                                ...
                                ArrayAdapter<String> jumObatAdapter = new ArrayAdapter<>(EditKunjunganBaruDataPlanActivity.this,
                                ...
                                ArrayAdapter<String> imunisasiTTAdapter = new ArrayAdapter<String>(EditKunjunganBaruDataPlanActivity.this,
                                        android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.ya_tidak));
                                ...
                                ArrayAdapter<String> yangKeAdapter = new ArrayAdapter<String>(EditKunjunganBaruDataPlanActivity.this,
                            ...
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Data Plan Tidak Ada!" + e.toString(), Toast.LENGTH_SHORT).show();
                            loadingDialog.dissmissDialog();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditKunjunganBaruDataPlanActivity.this, "Koneksi Gagal!" + error.toString(), Toast.LENGTH_SHORT).show();
                loadingDialog.dissmissDialog();
            }
        }) {
        };
        RequestQueue requestQueue = Volley.newRequestQueue(EditKunjunganBaruDataPlanActivity.this);
        requestQueue.add(stringRequest);
    }
}