...
import com.cikarastudio.cikarasimetalia.activity.kunjunganbaru.EditKunjunganBaruDataRujukanActivity;
...
public class EditKunjunganLamaDataRujukanActivity extends AppCompatActivity {
    ...
    String id_kunjunganLama, tanggal_rujukan;
    ...
    private static final String URL_UPDATERUJUKANLAMA = "http://simetalia.com/android/update_rujukan_lama.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(EditKunjunganLamaDataRujukanActivity.this);
        loadingDialog.startLoading();

        Intent intent = getIntent();
        id_kunjunganLama = intent.getStringExtra(ID_KUNJUNGANLAMA);

        tv_editRujukanBaruTanggalRujukan = findViewById(R.id.tv_editRujukanLamaTanggal);
        sp_editRujukanBaruFaskes = findViewById(R.id.sp_editRujukanLamaFaskes);
        tv_editRujukanBaruNamaFaskes = findViewById(R.id.tv_editRUjukanLamaNamaFaskes);
        tv_editRUjukanBaruAlasanDirujuk = findViewById(R.id.tv_editRUjukanLamaAlasanDirujuk);
        tv_editRUjukanDiagnosaSementara = findViewById(R.id.tv_editRUjukanDiagnosaSementaraLama);
        tv_editRujukanBaruTindakanSementara = findViewById(R.id.tv_editRujukanLamaTindakanSementara);
        btn_toggleEditRujukanBaru = findViewById(R.id.btn_toggleEditRujukanLama);
        btn_updateDataRujukanBaru = findViewById(R.id.btn_updateDataRujukanLama);
    ...
    private void updateDataRujukanBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATERUJUKANLAMA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Update Data Rujukan Berhasil", Toast.LENGTH_LONG).show();
                                loadingDialog.dissmissDialog();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Update Data Rujukan Gagal!", Toast.LENGTH_LONG).show();
                            loadingDialog.dissmissDialog();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Update Data Rujukan Gagal! : Cek Koneksi Anda", Toast.LENGTH_LONG).show();
                        loadingDialog.dissmissDialog();
                    }
                }) {
            @Override
    ...
    private void toggleRUjukanBaru() {
        if (!tv_editRujukanBaruTanggalRujukan.isEnabled()) {
            ...
            Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Mode Edit Diaktifkan!", Toast.LENGTH_LONG).show();
            ...
            sp_editRujukanBaruFaskes.setEnabled(false);
            Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Mode Edit Dinonaktifkan!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadDataRujukanBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_READBOOKING,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                ArrayAdapter<String> faskesAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataRujukanActivity.this,
                            ...
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Data Ibu Rujukan Tidak Ada!" + e.toString(), Toast.LENGTH_SHORT).show();
                            loadingDialog.dissmissDialog();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditKunjunganLamaDataRujukanActivity.this, "Koneksi Gagal!" + error.toString(), Toast.LENGTH_SHORT).show();
                loadingDialog.dissmissDialog();
            }
        }) {
        };
        RequestQueue requestQueue = Volley.newRequestQueue(EditKunjunganLamaDataRujukanActivity.this);
        requestQueue.add(stringRequest);
    }
}