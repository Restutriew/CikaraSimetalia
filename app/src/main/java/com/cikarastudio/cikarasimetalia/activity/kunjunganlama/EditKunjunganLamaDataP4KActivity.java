...
import com.cikarastudio.cikarasimetalia.activity.kunjunganbaru.EditKunjunganBaruDataP4KActivity;
...
public class EditKunjunganLamaDataP4KActivity extends AppCompatActivity {
    ...
    String id_kunjunganLama, buku_kia, stiker;
    ...
    private static final String URL_UPDATEP4KLAMA = "http://simetalia.com/android/update_p4k_lama.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(EditKunjunganLamaDataP4KActivity.this);
        loadingDialog.startLoading();

        Intent intent = getIntent();
        id_kunjunganLama = intent.getStringExtra(ID_KUNJUNGANLAMA);

        sp_editP4KPenolongSalinBaru = findViewById(R.id.sp_editP4KPenolongSalinLama);
        tv_editP4KNamaPenolongBaru = findViewById(R.id.tv_editP4KNamaPenolongLama);
        sp_editP4KTempatSalinBaru = findViewById(R.id.sp_editP4KTempatSalinLama);
        tv_editP4KNamaTempatBaru = findViewById(R.id.tv_editP4KNamaTempatLama);
        tv_editP4KPendampingSalinBaru = findViewById(R.id.tv_editP4KPendampingSalinLama);
        sp_editP4KKendaraanBaru = findViewById(R.id.sp_editP4KKendaraanLama);
        sp_editP4KKepemilikanBaru = findViewById(R.id.sp_editP4KKepemilikanLama);
        sp_editP4KBiayaSalinBaru = findViewById(R.id.sp_editP4KBiayaSalinLama);
        sp_editP4KCalonDonorBaru = findViewById(R.id.sp_editP4KCalonDonorLama);
        tv_editP4KNamaPendonorBaru = findViewById(R.id.tv_editP4KNamaPendonorLama);
        tv_editP4KBukuKIABaru = findViewById(R.id.tv_editP4KBukuKIALama);
        tv_editP4KBukuStikerBaru = findViewById(R.id.tv_editP4KBukuStikerLama);
        btn_toggleEditP4KBaru = findViewById(R.id.btn_toggleEditP4KLama);
        btn_updateDataP4KBaru = findViewById(R.id.btn_updateDataP4KLama);
    ...
    private void updateDataP4KBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATEP4KLAMA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Update Data P4K Berhasil", Toast.LENGTH_LONG).show();
                                loadingDialog.dissmissDialog();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Update Data P4k Gagal!", Toast.LENGTH_LONG).show();
                            loadingDialog.dissmissDialog();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Update Data P4k Gagal! : Cek Koneksi Anda", Toast.LENGTH_LONG).show();
                        loadingDialog.dissmissDialog();
                    }
                }) {
            @Override
    ...
    private void togglep4kBaru() {
        if (!tv_editP4KNamaPenolongBaru.isEnabled()) {
            ...
            Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Mode Edit Diaktifkan!", Toast.LENGTH_LONG).show();
            ...
            sp_editP4KBiayaSalinBaru.setEnabled(false);
            sp_editP4KCalonDonorBaru.setEnabled(false);
            Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Mode Edit Dinonaktifkan!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadDatap4k() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_READBOOKING,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                ArrayAdapter<String> penolongSalinAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataP4KActivity.this,
                                ...
                                ArrayAdapter<String> tempatSalinAdapter = new ArrayAdapter<>(EditKunjunganLamaDataP4KActivity.this,
                                ...
                                ArrayAdapter<String> kendaraanAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataP4KActivity.this,
                                ...
                                ArrayAdapter<String> kepemilikanAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataP4KActivity.this,
                                ...
                                ArrayAdapter<String> biayaSalinAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataP4KActivity.this,
                                ...
                                ArrayAdapter<String> calonDonorAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataP4KActivity.this,
                            ...
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Data P4K Tidak Ada!" + e.toString(), Toast.LENGTH_SHORT).show();
                            loadingDialog.dissmissDialog();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditKunjunganLamaDataP4KActivity.this, "Koneksi Gagal!" + error.toString(), Toast.LENGTH_SHORT).show();
                loadingDialog.dissmissDialog();
            }
        }) {
        };
        RequestQueue requestQueue = Volley.newRequestQueue(EditKunjunganLamaDataP4KActivity.this);
        requestQueue.add(stringRequest);
    }
}