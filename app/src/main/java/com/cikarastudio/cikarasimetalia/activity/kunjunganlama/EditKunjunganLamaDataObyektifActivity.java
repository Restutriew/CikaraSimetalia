...
public class EditKunjunganLamaDataObyektifActivity extends AppCompatActivity {
    ...
    private static final String URL_UPDATEOBYEKTIFLAMA = "http://simetalia.com/android/update_obyektif_lama.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(EditKunjunganLamaDataObyektifActivity.this);
        loadingDialog.startLoading();

        Intent intent = getIntent();
        id_kunjunganLama = intent.getStringExtra(ID_KUNJUNGANLAMA);

        sp_editObyektifBaruKeadaanUmum = findViewById(R.id.sp_editObyektifLamaKeadaanUmum);
        sp_editObyektifBaruKesadaran = findViewById(R.id.sp_editObyektifLamaKesadaran);
        tv_editObyektifBaruBeratBadan = findViewById(R.id.tv_editObyektifLamaBeratBadan);
        tv_editObyektifBaruTinggiBadan = findViewById(R.id.tv_editObyektifLamaTinggiBadan);
        tv_editObyektifBaruLiLa = findViewById(R.id.tv_editObyektifLamaLiLa);
        tv_editObyektifBaruTD = findViewById(R.id.tv_editObyektifLamaTD);
        tv_editObyektifBaruPulse = findViewById(R.id.tv_editObyektifLamaPulse);
        tv_editObyektifBaruRespirasi = findViewById(R.id.tv_editObyektifLamaRespirasi);
        tv_editObyektifBaruSuhu = findViewById(R.id.tv_editObyektifLamaSuhu);
        tv_editObyektifBaruKepala = findViewById(R.id.tv_editObyektifLamaKepala);
        tv_editObyektifBaruMuka = findViewById(R.id.tv_editObyektifLamaMuka);
        tv_editObyektifBaruLeher = findViewById(R.id.tv_editObyektifLamaLeher);
        tv_editOByektifBaruDada = findViewById(R.id.tv_editOByektifLamaDada);
        tv_editObyektifBaruBentukPerut = findViewById(R.id.tv_editObyektifLamaBentukPerut);
        sp_editObyektifBaruStriaeGravidarum = findViewById(R.id.sp_editObyektifLamaStriaeGravidarum);
        sp_editOByektifBaruLinea = findViewById(R.id.sp_editOByektifLamaLinea);
        sp_editOByektifBaruBekasLuka = findViewById(R.id.sp_editOByektifLamaBekasLuka);
        tv_editObyektifBaruLeopold1 = findViewById(R.id.tv_editObyektifLamaLeopold1);
        tv_editObyektifBaruLeopold2 = findViewById(R.id.tv_editObyektifLamaLeopold2);
        tv_editObyektifBaruLeopold3 = findViewById(R.id.tv_editObyektifLamaLeopold3);
        tv_editObyektifBaruLeopold4 = findViewById(R.id.tv_editObyektifLamaLeopold4);
        tv_editObyektifBaruTFU = findViewById(R.id.tv_editObyektifLamaTFU);
        tv_editObyektifBaruDJJ = findViewById(R.id.tv_editObyektifLamaDJJ);
        tv_editObyektifBaruGerakanJanin = findViewById(R.id.tv_editObyektifLamaGerakanJanin);
        tv_editObyektifBaruLingkarPerut = findViewById(R.id.tv_editObyektifLamaLingkarPerut);
        tv_editObyektifBaruKontraksi = findViewById(R.id.tv_editObyektifLamaKontraksi);
        sp_editObyektifBaruVulva = findViewById(R.id.sp_editObyektifLamaVulva);
        sp_editObyektifBaruVarises = findViewById(R.id.sp_editObyektifLamaVarises);
        sp_editObyektifBaruEdema = findViewById(R.id.sp_editObyektifLamaEdema);
        sp_editObyektifBaruRefleks = findViewById(R.id.sp_editObyektifLamaRefleks);
        tv_editObyektifBaruHB = findViewById(R.id.tv_editObyektifLamaHB);
        tv_editObyektifBaruProtein = findViewById(R.id.tv_editObyektifLamaProtein);
        tv_editObyektifBaruGlukosa = findViewById(R.id.tv_editObyektifLamaGlukosa);
        tv_editObyektifBaruHBSAG = findViewById(R.id.tv_editObyektifLamaHBSAG);
        tv_editObyektifBaruHIV = findViewById(R.id.tv_editObyektifLamaHIV);
        tv_editObyektifBaruLainnyaLab = findViewById(R.id.tv_editObyektiflamaLainnyaLab);
        tv_editObyektifBaruUSG = findViewById(R.id.tv_editObyektifLamaUSG);
        tv_editObyektifBaruPenunjangLain = findViewById(R.id.tv_editObyektifLamaPenunjangLain);
        btn_toggleEditObyektifBaru = findViewById(R.id.btn_toggleEditObyektifLama);
        btn_updateDataObyektifBaru = findViewById(R.id.btn_updateDataObyektifLama);
    ...
    private void updateDataObyektifBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATEOBYEKTIFLAMA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Update Data Obyektif Berhasil", Toast.LENGTH_LONG).show();
                                loadingDialog.dissmissDialog();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Update Data Obyektif Gagal!", Toast.LENGTH_LONG).show();
                            loadingDialog.dissmissDialog();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Update Data Obyektif Gagal! : Cek Koneksi Anda", Toast.LENGTH_LONG).show();
                        loadingDialog.dissmissDialog();
                    }
                }) {
            @Override
    ...
    private void toggleObyektifBaru() {
        if (!tv_editObyektifBaruBeratBadan.isEnabled()) {
            ...
            Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Mode Edit Diaktifkan!", Toast.LENGTH_LONG).show();
            ...
            sp_editObyektifBaruEdema.setEnabled(false);
            sp_editObyektifBaruRefleks.setEnabled(false);
            Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Mode Edit Dinonaktifkan!", Toast.LENGTH_SHORT).show();
        }
    }

    private void loadDataObyektif() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_READBOOKING,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success.equals("1")) {
                                ...
                                ArrayAdapter<String> keadaanUmumAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                ...
                                ArrayAdapter<String> kesadaranAdapter = new ArrayAdapter<>(EditKunjunganLamaDataObyektifActivity.this,
                                ...
                                ArrayAdapter<String> striaeGravidarumAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                ...
                                ArrayAdapter<String> lineaAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                        android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.ya_tidak));
                                ...
                                ArrayAdapter<String> bekasLukaAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                        android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.ya_tidak));
                                ...
                                ArrayAdapter<String> vulvaAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                ...
                                ArrayAdapter<String> varisesAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                        android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.ya_tidak));
                                ...
                                ArrayAdapter<String> edemaAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                                        android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.ya_tidak));
                                ...
                                ArrayAdapter<String> refleksAdapter = new ArrayAdapter<String>(EditKunjunganLamaDataObyektifActivity.this,
                            ...
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Data Obyektif Tidak Ada!" + e.toString(), Toast.LENGTH_SHORT).show();
                            loadingDialog.dissmissDialog();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditKunjunganLamaDataObyektifActivity.this, "Koneksi Gagal!" + error.toString(), Toast.LENGTH_SHORT).show();
                loadingDialog.dissmissDialog();
            }
        }) {
        };
        RequestQueue requestQueue = Volley.newRequestQueue(EditKunjunganLamaDataObyektifActivity.this);
        requestQueue.add(stringRequest);
    }
}