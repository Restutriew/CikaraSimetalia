...
import com.cikarastudio.cikarasimetalia.activity.kunjunganbaru.EditKunjunganBaruDataAnalisisActivity;
...
public class EditKunjunganLamaDataAnalisisActivity extends AppCompatActivity {
    ...
    private static final String URL_UPDATEAANALISISLAMA = "http://simetalia.com/android/update_analisis_lama.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingDialog = new LoadingDialog(EditKunjunganLamaDataAnalisisActivity.this);
        loadingDialog.startLoading();

        Intent intent = getIntent();
        id_kunjunganLama = intent.getStringExtra(ID_KUNJUNGANLAMA);

        tv_editAnalisisBaruAnalisis = findViewById(R.id.tv_editAnalisisLamaAnalisis);
        btn_toggleEditAnalisisBaru = findViewById(R.id.btn_toggleEditAnalisisLama);
        btn_updateDataAnalisisBaru = findViewById(R.id.btn_updateDataAnalisisLama);
    ...
    private void updateDataAnalisis() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_UPDATEAANALISISLAMA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (success.equals("1")) {
                                Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Update Data Analisis Berhasil", Toast.LENGTH_LONG).show();
                                loadingDialog.dissmissDialog();
                            }

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Update Data Analisis Gagal!", Toast.LENGTH_LONG).show();
                            loadingDialog.dissmissDialog();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Update Data Analisis Gagal! : Cek Koneksi Anda", Toast.LENGTH_LONG).show();
                        loadingDialog.dissmissDialog();
                    }
                }) {
            @Override
    ...
    private void toggleDataAnalisis() {
        if (!tv_editAnalisisBaruAnalisis.isEnabled()) {
            ...
            Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Mode Edit Diaktifkan!", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Mode Edit Dinonaktifkan!", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadDataAnalisisBaru() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_READBOOKING,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Data Analisis Tidak Ada!" + e.toString(), Toast.LENGTH_SHORT).show();
                            loadingDialog.dissmissDialog();
                        }
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(EditKunjunganLamaDataAnalisisActivity.this, "Koneksi Gagal!" + error.toString(), Toast.LENGTH_SHORT).show();
                loadingDialog.dissmissDialog();
            }
        }) {
        };
        RequestQueue requestQueue = Volley.newRequestQueue(EditKunjunganLamaDataAnalisisActivity.this);
        requestQueue.add(stringRequest);
    }
}